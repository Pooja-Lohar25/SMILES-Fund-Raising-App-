...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <main>
      <div class="course">
        <div class="vdo">
          <video src="sampleVdo_learning.mp4" width="800px" controls >
              
          </video>
        </div>
        <div class="contents">
          <div class="content">
          <p> <a href="musicQuiz.php" style="text-decoration:none; color:black"> Programming: Attempt Quiz</a> </p><p class="time">MM:20</p>
          </div>
        </div>
      </div>
    </main>
