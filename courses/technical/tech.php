<?php
session_start();
$_SESSION['courseId'] = 101;//course id of technical courses
...
<html lang="en" dir="ltr" >
  ...
  <body onload="enrl()" >
    ...
    <main>
      <div class="course">
        <div class="vdo">
          <video src="What is a Computer Program and How Does It Work_.mp4" width="800px" controls >
        ...
        <div class="contents">
          <div class="content">
          <p> <a  id="quizLink"  style="text-decoration:none; color:black"> Programming: Attempt Quiz</a> </p><p class="time">MM:20</p>
          </div>
        </div>
      </div>
    </main>
