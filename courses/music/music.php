...
<?php
session_start();
$_SESSION['courseId'] = 105;//course id of music courses
...
<html lang="en" dir="ltr">
    ...
    <script>
      function enrl()
      {
        ...
        if(is_enroll=="true") 
        {
          ...
          document.getElementById("quizLink").setAttribute("href","musicQuiz.php");
        }
        else{
  ...
  <body onload="enrl()">
    ...
    <main>
      <div class="course">
        <div class="vdo">
          <video src="(Part1) 11 Basic Guitar Chords that every Beginner Guitarist should know _ Open Major & Minor Chords.mp4" width="800px" controls >
        ...
        <div class="contents">
          <div class="content">
          <p> <a id="quizLink" style="text-decoration:none; color:black"> Guitar basics: Attempt Quiz</a> </p><p class="time">MM:20</p>
          </div>
        </div>
      </div>
    </main>
