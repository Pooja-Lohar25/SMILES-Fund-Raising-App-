<?php
session_start();
$_SESSION['courseId'] = 103;//course id of film making courses
...
<html lang="en" dir="ltr">
    ...
    <script>
      function enrl()
      {
        ...
        if(is_enroll=="true") 
        {
          ...
          document.getElementById("quizLink").setAttribute("href","filmQuiz.php");
        }
        else{
  ...
  <body onload="enrl()">
    ...
    <main>
      <div class="course">
        <div class="vdo">
          <video src="Film Making Basics_ Everything you need to know in 8 minutes!.mp4" width="800px" controls >
        ...
        <div class="contents">
          <div class="content">
          <p> <a id="quizLink" style="text-decoration:none; color:black"> Film Making: Attempt Quiz</a> </p><p class="time">MM:20</p>
          </div>
        </div>
      </div>
    </main>
