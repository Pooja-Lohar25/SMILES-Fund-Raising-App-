<?php
session_start();
$_SESSION['courseId'] = 108;//course id of video courses
...
<html lang="en" dir="ltr">
    ...
    <script>
      function enrl()
      {
        ...
        if(is_enroll=="true") 
        {
          ...
          document.getElementById("quizLink").setAttribute("href","videoQuiz.php");
        }
        else{
  ...
  <body onload="enrl()">
    ...
    <main>
      <div class="course">
        <div class="vdo">
          <video src="Total Beginner’s Guide to Video Editing.mp4" width="800px" controls >
        ...
        <div class="contents">
          <div class="content">
          <p> <a id="quizLink" style="text-decoration:none; color:black"> Video Editing: Attempt Quiz</a> </p><p class="time">MM:20</p>
          </div>
        </div>
      </div>
    </main>
