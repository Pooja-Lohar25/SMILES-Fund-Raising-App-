...
<?php
session_start();
$_SESSION['courseId'] = 107;//course id of content courses
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Content Writing-Email writing</title>
    <link rel="stylesheet" href="../../main/navbar.css">
    <link rel="stylesheet" href="../../main/footer.css">
    <link rel="stylesheet" href="../../main/layoutC.css">
    ...
    <script>
      function enrl()
      {
        ...
        if(is_enroll=="true") 
        {
          ...
          document.getElementById("quizLink").setAttribute("href","contentQuiz.php");
        }
        else{
  ...
  <body onload="enrl()">
    <header>
      <nav id="navbar">
          <ul>
              <li class="item"><a href="../../main/main.php"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>
              <li class="item"><a href="../../main/about.html"><i class="fa fa-info-circle" aria-hidden="true"></i> About us</a></li>
              <li class="item"><a href="../../main/service.html"><i class="fa fa-shopping-bag" aria-hidden="true"></i> Services</a></li>
          </ul>
         </nav>
    </header>
    <main>
      <div class="course">
        <div class="vdo">
          <video src="Email Writing _ How to write an Email _ Format _ Example _ Exercise _ Writing Skills.mp4" width="800px" controls >
        ...
        <div class="contents">
          <div class="content">
          <p> <a id="quizLink" style="text-decoration:none; color:black"> Content Writing: Attempt Quiz</a> </p><p class="time">MM:20</p>
          </div>
        </div>
      </div>
    </main>
