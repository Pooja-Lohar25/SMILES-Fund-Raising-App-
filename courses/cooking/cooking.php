...
<?php
session_start();
$_SESSION['courseId'] = 104;//course id of cooking courses
...
<html lang="en" dir="ltr">
    ...
    <script>
      function enrl()
      {
        ...
        if(is_enroll=="true") 
        {
          ...
          document.getElementById("quizLink").setAttribute("href","cookingQuiz.php");
        }
        else{
  ...
  <body onload="enrl()">
    ...
    <main>
      <div class="course">
        <div class="vdo">
          <video src="Professional Baker Teaches You How To Make CHOCOLATE CHIP COOKIES!.mp4" width="800px" controls >
        ...
        <div class="contents">
          <div class="content">
          <p><a id="quizLink" style="text-decoration:none; color:black"> Cookie baking: Attempt Quiz</a> </p><p class="time">MM:20</p>
          </div>
        </div>
      </div>
    </main>
