...
<?php
session_start();
$_SESSION['courseId'] = 102;//course id of social media course
...
<html lang="en" dir="ltr">
    ...
    <script>
      function enrl()
      {
        ...
        if(is_enroll=="true") 
        {
          ...
          document.getElementById("quizLink").setAttribute("href","socialQuiz.php");
        }
        else{
  ...
  <body onload="enrl()">
    ...
    <main>
      <div class="course">
        <div class="vdo">
          <video src="The Evolution of Communication Through Social Media.mp4" width="800px" controls >
        ...
        <div class="contents">
          <div class="content">
          <p> <a id="quizLink" style="text-decoration:none; color:black"> Social Media: Attempt Quiz</a> </p><p class="time">MM:20</p>
          </div>
        </div>
      </div>
    </main>
